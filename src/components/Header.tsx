    ...
    <header className="py-8 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900 dark:to-indigo-900">
      <div className="container mx-auto px-4">
        <h1 className="text-center">
          <div className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 transform hover:scale-105 transition-transform duration-300">
            在别的城市要过上现在的生活
          </div>
        ...
        {/* 联系方式 - 同一行 */}
        <div className="flex justify-center items-center mt-4 text-sm text-gray-600 dark:text-gray-400">
          <a 
