...
const LifestyleSettings: React.FC<LifestyleSettingsProps> = ({ settings, onSettingChange }) => {
  ...
  return (
    <div className="lifestyle-settings p-5 bg-white dark:bg-gray-800 rounded-lg shadow-md">
      <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-5 pb-2 border-b border-gray-100 dark:border-gray-700">生活方式设置</h3>
      
      {/* 分组1: 住房相关设置 */}
      <div className="mb-7 pb-6 border-b border-gray-100 dark:border-gray-700">
        <h4 className="flex items-center text-md font-medium text-blue-700 dark:text-blue-400 mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="flex flex-col">
            <label htmlFor="housingType" className="font-medium text-gray-700 dark:text-gray-300 mb-1">住房方式</label>
            <select 
              id="housingType" 
              className="border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
          ...
          <div className="flex flex-col">
            <label htmlFor="housingLocation" className="font-medium text-gray-700 dark:text-gray-300 mb-1">住房位置</label>
            <select 
              id="housingLocation" 
              className="border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
          ...
          <div className="flex flex-col">
            <label htmlFor="housingSize" className="font-medium text-gray-700 dark:text-gray-300 mb-1">住房大小</label>
            <select 
              id="housingSize" 
              className="border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
        ...
        {settings.housingType === 'buy' && (
          <div className="mt-5 p-4 rounded-lg bg-blue-50 dark:bg-blue-900 border-l-4 border-blue-200 dark:border-blue-700">
            <p className="text-sm text-blue-700 dark:text-blue-300 mb-3 font-medium">购房贷款选项</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="flex flex-col">
                <label htmlFor="loanInterestRate" className="font-medium text-gray-700 dark:text-gray-300 mb-1">贷款年利率 (%)</label>
                <div className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm font-semibold text-blue-600 dark:text-blue-400 min-w-[45px] text-right">{(settings.loanInterestRate * 100).toFixed(1)}%</span>
                </div>
              ...
              <div className="flex flex-col">
                <label htmlFor="loanTerm" className="font-medium text-gray-700 dark:text-gray-300 mb-1">贷款期限 (年)</label>
                <select 
                  id="loanTerm" 
                  className="border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
      ...
      <div className="mb-7 pb-6 border-b border-gray-100 dark:border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="flex flex-col">
            <label htmlFor="companyMeals" className="font-medium text-gray-700 dark:text-gray-300 mb-1">公司提供餐食</label>
            <select 
              id="companyMeals" 
              className="border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
          ...
          <div className="flex flex-col">
            <label htmlFor="diningHomeRatio" className="font-medium text-gray-700 dark:text-gray-300 mb-1">
            ...
            <div className="flex items-center mt-1">
              ...
              />
              <span className="ml-2 text-sm font-semibold text-blue-600 dark:text-blue-400 min-w-[40px] text-right">{settings.diningHomeRatio}%</span>
            </div>
          ...
          <div className="flex flex-col">
            <label htmlFor="transportType" className="font-medium text-gray-700 dark:text-gray-300 mb-1">交通方式</label>
            <select 
              id="transportType" 
              className="border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
            ...
            {settings.transportType === 'car' && (
              <div className="mt-3 p-3 rounded-lg bg-gray-50 dark:bg-gray-800 border-l-4 border-gray-200 dark:border-gray-700">
                <div className="flex flex-col">
                  <label htmlFor="carLoanMonthlyPayment" className="font-medium text-gray-700 dark:text-gray-300 mb-1">每月车贷 (元)</label>
                  <input 
                    type="number" 
          ...
          <div className="flex flex-col">
            <label htmlFor="entertainmentLevel" className="font-medium text-gray-700 dark:text-gray-300 mb-1">娱乐水平</label>
            <select 
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
          <div className="flex flex-col">
            <label htmlFor="childrenCount" className="font-medium text-gray-700 dark:text-gray-300 mb-1">子女数量</label>
            <select 
              id="childrenCount" 
              className="border border-gray-300 dark:border-gray-600 rounded-md py-2 px-3 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
          ...
          {Array.from({ length: settings.childrenCount }).map((_, index) => (
            <div className="flex flex-col" key={`education-${index}`}>
              <label htmlFor={`educationType-${index}`} className="font-medium text-gray-700 dark:text-gray-300 mb-1">
                子女{index + 1}教育阶段
              </label>
              <select 
          ...
          {settings.childrenCount === 0 && (
            <div className="col-span-3 flex items-center text-sm text-gray-500 dark:text-gray-400 italic">
              未设置子女，教育支出将为零
            </div>
          )}
        </div>
